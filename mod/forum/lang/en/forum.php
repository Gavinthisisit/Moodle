...
$string['bynameondateandpoint'] = 'by {$a->name} - {$a->date}&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspreward:{$a->point}';
...
$string['someone'] = 'Some student';
$string['questionview'] = 'Question view';
$string['Question'] = 'Question';
$string['collaborationforum'] = 'Collaboration';
$string['reward'] = 'Reward';
$string['rewardpoint'] = 'Rewardpoint';
$string['apply'] = 'Apply';
$string['pass'] = 'Applyconfirm';
$string['acceptanswer'] = 'Are you sure you want to accept this answer?';
$string['addanewdiscussion'] = 'Askanewquestion';
$string['pointreward'] = 'pointreward';
$string['rewarding'] = 'you are giving point to the student who provides this anwser,the minimal point is 1.Your reward points of this question is{$a->totalpoint},you already spent{$a->spent}points.{$a->left}more answer need to deal,so please be caleful.Attention:Once the point is given,you cannot change it anymore!';
$string['confirm'] = 'Confirm';
$string['rewardpoints'] ='Total rewardpoints each student should have';
$string['askanewquestion'] = 'Askanewrewardquestion';