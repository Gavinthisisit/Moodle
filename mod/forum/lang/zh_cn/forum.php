...
/**
 * Strings for component 'forum', language 'zh_cn', branch 'MOODLE_29_STABLE'
 *
 * @package   forum
...
$string['bynameondateandpoint'] = '由 {$a->name} 发表于 {$a->date}&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp评分:{$a->point}';
...
$string['someone'] = '某同学';
$string['questionview'] = '问题查看';
$string['Question'] = '问题:';
$string['collaborationforum'] = '学生互助区';
$string['reward'] = '奖励设置';
$string['rewardpoint'] = '悬赏分';
$string['apply'] = '申请回答';
$string['pass'] = '通过申请';
$string['acceptanswer'] = '你确定要通过该申请吗？一旦通过你必须接受该回答者的回答，并且给其不少于1分的悬赏分。';
$string['addanewdiscussion'] = '发布新问题';
$string['pointreward'] = '分数奖励';
$string['rewarding'] = '您正在对下面的回答进行评分，评分最低为1分。您的该问题的悬赏分为{$a->totalpoint},您已经给出{$a->spent}分。您还有{$a->left}个回答需要评分，请酌情给分。注意：分数一旦给出无法修改！';
$string['confirm'] = '确定';
$string['rewardpoints'] = '每个学生的悬赏基础总分';
$string['askanewquestion'] = '发布一个悬赏问题';