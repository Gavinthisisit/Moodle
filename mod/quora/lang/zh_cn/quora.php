...
/**
 * Strings for component 'quora', language 'zh_cn', branch 'MOODLE_29_STABLE'
 *
 * @package   quora
...
$string['blockafter_help'] = '此项设置决定用户在指定的时长内最多允许发几个帖子。有mod/quora:postwithoutthrottling权限的用户不受此限。';
$string['blockperiod'] = '阻塞统计周期';
$string['blockperioddisabled'] = '不阻塞';
$string['blockperiod_help'] = '学生如果在指定的时长内发了达到指定数量的帖子，会被阻止继续发帖。有mod/quora:postwithoutthrottling权限的用户不受此限。';
$string['blogquora'] = '博客形式的标准讨论区';
...
$string['cannotaddteacherquorato'] = '不能在课程的第0节添加转换过的教师讨论区';
...
$string['cannotfindorcreatequora'] = '无法找到或建立网站的主新闻讨论区';
$string['cannotfindparentpost'] = '无法找到帖子{$a}的祖先';
$string['cannotmovefromsinglequora'] = '不能从单个话题讨论区移动话题';
$string['cannotmovenotvisible'] = '讨论区不可见';
$string['cannotmovetonotexist'] = '您不能移动到那个讨论区 - 它不存在';
$string['cannotmovetonotfound'] = '课程中找不到目标讨论区';
$string['cannotmovetosinglequora'] = '不能将话题移动到单个简单话题讨论区';
$string['cannotpurgecachedrss'] = '无法清理目标或源讨论区的RSS种子缓存 - 检查你的文件permissionsquoras';
...
$string['configlongpost'] = '超过该长度(字符个数，不含 HTML)的帖子被认为是长帖子。在网站首页、社区格式的课程页或用户资料显示的帖子会被精简到一个自然的中断位置，其长度在 quora_shortpost 和 quora_longpost 之间。';
...
$string['discussionmovedpost'] = '此话题已经移到</a>讨论区<a href="{$a->quorahref}">{$a->quoraname}</a>中的<a href="{$a->discusshref}">这里了</a>';
$string['discussionname'] = '话题名称';
$string['discussionsubscription'] = '关注此问题';
$string['discussionsubscription_help'] = '关注问题意味着有新回复时你会收到邮件提醒';
...
$string['eachuserquora'] = '每个人发表一个话题';
$string['edit'] = '编辑';
...
$string['emaildigestupdated'] = '这是发送帖子摘要的选项，已经把 \'{$a->quora}\'更改为 \'{$a->maildigesttitle}\' 。 {$a->maildigestdescription}';
$string['emaildigestupdated_default'] = '\'{$a->quora}\'讨论区将使用你在资料中的\'{$a->maildigesttitle}\'默认设置。{$a->maildigestdescription}';
...
$string['quora'] = '讨论区';
$string['quora:addinstance'] = '添加新讨论区';
$string['quora:addnews'] = '发布新闻';
$string['quora:addquestion'] = '提问';
$string['quora:allowforcesubscribe'] = '允许强制订阅';
$string['quoraauthorhidden'] = '作者(隐藏)';
$string['quorablockingalmosttoomanyposts'] = '您已经达到发帖的极限。在过去的 {$a->blockperiod} 里，您已经发表了 {$a->numposts} 个帖子。这个极限是 {$a->blockafter} 个帖子。';
$string['quorabodyhidden'] = '您不能看这个帖子，可能因为您还没有参与到这个话题中，或者还未达到帖子的最长编辑时限，或者讨论还未开始或已经结束。';
$string['quora:createattachment'] = '上传附件';
$string['quora:deleteanypost'] = '删除任何帖子（任何时间）';
$string['quora:deleteownpost'] = '删除自己的帖子（在截止时间之内）';
$string['quora:editanypost'] = '编辑任何帖子';
$string['quora:exportdiscussion'] = '导出整个话题';
$string['quora:exportownpost'] = '导出自己的帖子';
$string['quora:exportpost'] = '导出帖子';
$string['quoraintro'] = '讨论区简介';
$string['quora:managesubscriptions'] = '管理订阅';
$string['quora:movediscussions'] = '移动话题';
$string['quoraname'] = '讨论区名称';
$string['quoraposts'] = '讨论区帖子';
$string['quora:postwithoutthrottling'] = '不受发帖阈值限制';
$string['quora:rate'] = '评价帖子';
$string['quora:replynews'] = '回复新闻';
$string['quora:replypost'] = '回复帖子';
$string['quoras'] = '讨论区';
$string['quora:splitdiscussions'] = '分割话题';
$string['quora:startdiscussion'] = '开启新的话题';
$string['quorasubjecthidden'] = '主题(隐藏)';
$string['quoratracked'] = '跟踪未读帖子';
$string['quoratrackednot'] = '不跟踪未读帖子';
$string['quoratype'] = '讨论区类型';
$string['quoratype_help'] = '有5种讨论区类型：
...
$string['quora:viewallratings'] = '查看所有由个人给出的原始评分';
$string['quora:viewanyrating'] = '查看任何人的总分';
$string['quora:viewdiscussion'] = '阅读话题';
$string['quora:viewhiddentimedposts'] = '阅读隐藏的定时帖子';
$string['quora:viewqandawithoutposting'] = '始终可看提问帖和回答帖';
$string['quora:viewrating'] = '查看自己的总分';
$string['quora:viewsubscribers'] = '查看订阅者';
$string['generalquora'] = '一般用途的标准讨论区';
$string['generalquoras'] = '普通讨论区';
$string['hiddenquorapost'] = '隐藏讨论区帖子内容';
$string['inquora'] = '在 {$a} 里';
...
$string['nopostquora'] = '很抱歉，您不能在此讨论区发帖';
$string['noposts'] = '没有帖子';
...
$string['nownotsubscribed'] = '{$a->name}将不再收到“{$a->quora}”新帖子的通知';
$string['nownottracking'] = '{$a->name} 不再跟踪“{$a->quora}”了。';
$string['nowsubscribed'] = '“{$a->quora}”有新帖子会通知{$a->name}';
$string['nowtracking'] = '{$a->name} 现在跟踪“{$a->quora}”。';
...
$string['page-mod-quora-discuss'] = '讨论区模块话题页';
$string['page-mod-quora-view'] = '讨论区模块主页';
$string['page-mod-quora-x'] = '任意讨论区模块页面';
$string['parent'] = '显示父帖子';
$string['parentofthispost'] = '该帖的父帖';
$string['pluginadministration'] = '讨论区管理';
$string['pluginname'] = '课程知乎';
...
$string['posttoquora'] = '发到讨论区上';
$string['postupdated'] = '您的帖子已经更新';
$string['potentialsubscribers'] = '潜在订阅者';
$string['praise'] = '点赞';
$string['praisecount'] = '有';
$string['praisecounted'] = '人赞了本回答';
...
$string['reply'] = '回复';
$string['replyquora'] = '回复到讨论区上';
$string['replytouser'] = '在回复中使用Email地址';
$string['resetquoras'] = '删除哪类讨论区类型中帖子';
$string['resetquorasall'] = '删除所有的帖子';
...
$string['searchquoraintro'] = '请在下面的一个或多个项目中输入搜索词条：';
$string['searchquoras'] = '搜索讨论区';
...
$string['searchwhichquoras'] = '选择要搜索哪个讨论区';
$string['searchwords'] = '这些文字可以在帖子的任何位置出现';
$string['seeallposts'] = '查看此用户发表的全部帖子';
$string['shortpost'] = '短帖';
$string['showsubscribers'] = '显示/修改订阅者';
$string['singlequora'] = '单个简单话题';
$string['smallmessage'] = '{$a->user}在{$a->quoraname}发帖';
...
$string['thisquoraisthrottled'] = '这个讨论区有规定周期内发帖数的限制，它被设置为 {$a->blockperiod} 内最多发 {$a->blockafter} 个帖子。';
$string['timedposts'] = '定时帖子';
$string['timestartenderror'] = '可视时段的结束时间不能早于开始时间。';
$string['trackquora'] = '跟踪未读帖子';
$string['tracking'] = '跟踪';
...
$string['unsubscribeallconfirmquoras'] = '你当前已经订阅{$a->quoras}论坛。你确认取消所有论坛的订阅，并禁用自动订阅讨论区？';
...
$string['warnafter_help'] = '当学生将达到某一时长内允许的最大发帖数时，会被警告。此项设置决定了发多少个帖子后会被警告。有mod/quora:postwithoutthrottling权限的用户不受此限。';
$string['warnformorepost'] = '警告！此讨论区有不只一个话题——正使用最新话题';
$string['yournewquestion'] = '您的新问题';
$string['yournewtopic'] = '您的新问题';
