...
Feature: A user can view their posts and discussions
  ...
  Scenario: View the student's posts and discussions
    ...
    And the following "activities" exist:
      ...
      | quora      | Test quora name        | Test quora  | C1     | quora        | 0         |
    And I log in as "student1"
    And I follow "Course 1"
    And I add a new discussion to "Test quora name" quora with:
      | Subject | Forum discussion 1 |
      | Message | How awesome is this quora discussion? |
    And I reply "Forum discussion 1" post from "Test quora name" quora with:
      | Message | Actually, I've seen better. |
    When I follow "Profile" in the user menu
    And I follow "Forum posts"
    Then I should see "How awesome is this quora discussion?"
    And I should see "Actually, I've seen better."
    And I follow "Profile" in the user menu
    And I follow "Forum discussions"
    And I should see "How awesome is this quora discussion?"
