...
Feature: As a teacher I need to see an accurate list of subscribed users
  In order to see who is subscribed to a quora
  As a teacher
  ...
  @javascript
  Scenario: A forced quora lists all subscribers
  ...
  Scenario: A forced quora does not allow to edit the subscribers
    When I add a "Forum" to section "1" and I fill the form with:
  ...
  Scenario: A forced and hidden quora lists only teachers
    When I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Forced Forum 2 |
      | Forum type        | Standard quora for general use |
      | Description       | Test quora description |
  ...
  @javascript
  Scenario: An automatic quora lists all subscribers
    When I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Forced Forum 1 |
      | Forum type        | Standard quora for general use |
      | Description       | Test quora description |
