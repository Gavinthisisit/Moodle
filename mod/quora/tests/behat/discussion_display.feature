...
Feature: Students can choose from 4 discussion display options and their choice is remembered
  In order to read quora posts in a suitable view
  As a user
  ...
  Background:
    ...
    And I reply "Discussion 1" post from "Test quora name" quora with:
    ...
    And I reply "Discussion 2" post from "Test quora name" quora with:
  ...
  Scenario: Display replies flat, with oldest first
    Given I reply "Discussion 1" post from "Test quora name" quora with:
    ...
    And I should see "Discussion contents 1, second message" in the "//div[contains(concat(' ', normalize-space(@class), ' '), ' quorapost ') and not(contains(@class, 'starter'))]" "xpath_element"
    And I reply "Discussion 2" post from "Test quora name" quora with:
    ...
    And I should see "Discussion contents 2, second message" in the "//div[contains(concat(' ', normalize-space(@class), ' '), ' quorapost ') and not(contains(@class, 'starter'))]" "xpath_element"
  ...
  Scenario: Display replies flat, with newest first
    ...
    Then I should see "Discussion contents 1, first message" in the "div.firstpost.starter" "css_element"
    And I should see "Discussion contents 1, third message" in the "//div[contains(concat(' ', normalize-space(@class), ' '), ' quorapost ') and not(contains(@class, 'starter'))]" "xpath_element"
    And I reply "Discussion 2" post from "Test quora name" quora with:
      | Subject | Reply 2 to discussion 2 |
      | Message | Discussion contents 2, third message |
    And the field "Display mode" matches value "Display replies flat, with newest first"
    And I should see "Discussion contents 2, first message" in the "div.firstpost.starter" "css_element"
    And I should see "Discussion contents 2, third message" in the "//div[contains(concat(' ', normalize-space(@class), ' '), ' quorapost ') and not(contains(@class, 'starter'))]" "xpath_element"

  Scenario: Display replies in threaded form
    Given I follow "Test quora name"
    ...
    And I should see "Reply 1 to discussion 1" in the "span.quorathread" "css_element"
    ...
    And I should see "Reply 1 to discussion 2" in the "span.quorathread" "css_element"
  ...
  Scenario: Display replies in nested form
    ...
    Then I should see "Discussion contents 1, first message" in the "div.firstpost.starter" "css_element"
    And I should see "Discussion contents 1, second message" in the "div.indent div.quorapost" "css_element"
    And I follow "Test quora name"
    And I follow "Discussion 2"
    And the field "Display mode" matches value "Display replies in nested form"
    And I should see "Discussion contents 2, first message" in the "div.firstpost.starter" "css_element"
    And I should see "Discussion contents 2, second message" in the "div.indent div.quorapost" "css_element"
