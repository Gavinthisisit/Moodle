 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_quora_existing_subscriber_selector extends mod_quora_subscriber_selector_base {
    ...
    public function find_users($search) {
        ...
        $subscribers = $DB->get_records_sql("SELECT $fields
                                              ...
                                              WHERE $wherecondition AND s.quora = :quoraid
        ...
        return array(get_string("existingsubscribers", 'quora') => $subscribers);
    }
