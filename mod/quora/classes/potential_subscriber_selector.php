...
/**
 * A user selector control for potential subscribers to the selected quora
 * @package   mod_quora
 * @copyright 2009 Sam Hemelryk
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_quora_potential_subscriber_selector extends mod_quora_subscriber_selector_base {
    /**
     * If set to true EVERYONE in this course is force subscribed to this quora
     * @var bool
     */
    ...
    public function find_users($search) {
        ...
        $cm = get_coursemodule_from_instance('quora', $this->quoraid);
        ...
        if ($this->forcesubscribed) {
            return array(get_string("existingsubscribers", 'quora') => $availableusers);
        } else {
            return array(get_string("potentialsubscribers", 'quora') => $availableusers);
        }
    }
    ...
    /**
     * Sets this quora as force subscribed or not
     */
