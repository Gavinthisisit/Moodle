...
/**
 * The mod_quora discussion_subscription deleted event.
 *
 * @package    mod_quora
...
/**
 * The mod_quora discussion_subscription deleted event class.
 *
...
class discussion_subscription_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdiscussionsubscriptiondeleted', 'mod_quora');
    }
