...
/**
 * The mod_quora post deleted event.
 *
 * @package    mod_quora
...
/**
 * The mod_quora post deleted event class.
 *
...
class post_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostdeleted', 'mod_quora');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'quora', 'delete post', $logurl, $this->objectid, $this->contextinstanceid);
    }
