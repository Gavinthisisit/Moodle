...
/**
 * The mod_quora user report viewed event.
 *
 * @package    mod_quora
...
/**
 * The mod_quora user report viewed event class.
 *
...
class user_report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserreportviewed', 'mod_quora');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/mod/quora/user.php', array('id' => $this->relateduserid,
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'quora', 'user report', $logurl, $this->relateduserid);
    }
