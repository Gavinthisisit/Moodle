...
/**
 * The mod_quora post updated event.
 *
 * @package    mod_quora
...
/**
 * The mod_quora post updated event class.
 *
...
class post_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostupdated', 'mod_quora');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'quora', 'update post', $logurl, $this->objectid, $this->contextinstanceid);
    }
