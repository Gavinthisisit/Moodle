YUI.add('moodle-mod_quora-subscriptiontoggle', function (Y, NAME) {
 ...
 * @main       moodle-mod_quora-subscriptiontoggle
 */

/**
 * @namespace M.mod_quora
...
var LOGNAME = 'moodle-mod_quora-subscriptiontoggle';
...
Y.extend(SubscriptionToggle, Y.Base, {
    ...
    _toggleSubscription: function(e) {
        ...
        Y.io(this.get('uri'), {
            data: {
                ...
                quoraid: clickedLink.getData('quoraid'),
    ...
    ATTRS: {
         ...
         * @attribute uri
         * @type String
         * @default M.cfg.wwwroot + '/mod/quora/subscribe_ajax.php'
         */
        uri: {
            value: M.cfg.wwwroot + '/mod/quora/subscribe_ajax.php'
        }
    }
});

var NS = Y.namespace('M.mod_quora.subscriptiontoggle');
