...
require_once($CFG->dirroot . '/mod/teamwork/eval/best/lib.php');
require_once($CFG->libdir . '/gradelib.php');


class teamworkeval_best_evaluation_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $teamwork = $this->getDataGenerator()->create_module('teamwork', array('evaluation' => 'best', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['teamwork'][$teamwork->id];
        $this->teamwork = new teamwork($teamwork, $cm, $course);
        $this->evaluator = new testable_teamwork_best_evaluation($this->teamwork);
    }
    ...
    public function test_assessments_distance_zero_variance() {
        ...
        // Simulate structure returned by {@link teamwork_best_evaluation::prepare_data_from_recordset()}
        $assessments = array(
        ...
        // Process assessments in the same way as in the {@link teamwork_best_evaluation::process_assessments()}
 ...
 */
class testable_teamwork_best_evaluation extends teamwork_best_evaluation {
