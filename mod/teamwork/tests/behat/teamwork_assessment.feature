@mod @mod_teamwork
Feature: Teamwork submission and assessment
  In order to use teamwork activity
  As a student
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | teamwork | TestTeamwork | Test teamwork description | c1     | teamwork1 |
# teacher1 sets up assessment form and changes the phase to submission
    When I log in as "teacher1"
    And I follow "Course1"
    And I edit assessment form in teamwork "TestTeamwork" as:"
      | id_description__idx_0_editor | Aspect1 |
      | id_description__idx_1_editor | Aspect2 |
      | id_description__idx_2_editor |         |
    And I change phase in teamwork "TestTeamwork" to "Submission phase"
    And I log out
# student1 submits
    And I log in as "student1"
    And I follow "Course1"
    And I follow "TestTeamwork"
    Then I should see "Submit your work"
    And I add a submission in teamwork "TestTeamwork" as:"
      | Title              | Submission1  |
...
# teacher1 allocates reviewers and changes the phase to assessment
    ...
    And I allocate submissions in teamwork "TestTeamwork" as:"
    ...
    And I change phase in teamwork "TestTeamwork" to "Assessment phase"
    And I log out
# student1 assesses work of student2 and student3
    ...
    And I assess submission "Sam2" in teamwork "TestTeamwork" as:"
      | grade__idx_0            | 5 / 10            |
    ...
    And I follow "Course1"
    And I assess submission "Sam3" in teamwork "TestTeamwork" as:"
      | grade__idx_0            | 9 / 10      |
...
# student2 assesses work of student1
    ...
    And I assess submission "Sam1" in teamwork "TestTeamwork" as:"
      | grade__idx_0            | 6 / 10     |
      | peercomment__idx_0      |            |
      | grade__idx_1            | 7 / 10     |
      | peercomment__idx_1      |            |
...
# teacher1 makes sure he can see all peer grades
    ...
    And I follow "Course1"
    And I follow "TestTeamwork"
    And I should see grade "52" for teamwork participant "Sam1" set by peer "Sam2"
    And I should see grade "60" for teamwork participant "Sam2" set by peer "Sam1"
    And I should see grade "-" for teamwork participant "Sam2" set by peer "Sam4"
    ...
    And I should see grade "68" for teamwork participant "Sam3" set by peer "Sam1"
...
# teacher1 assesses the work on submission1 and assesses the assessment of peer
    ...
    And I change phase in teamwork "TestTeamwork" to "Grading evaluation phase"
  ...
  @javascript
  Scenario: Add and assess submissions in teamwork with javascript enabled

  Scenario: Add and assess submissions in teamwork with javascript disabled
