...
/**
 * Change the current phase of the teamwork
 *
...
echo $OUTPUT->confirm(get_string('switchphase' . $phase . 'info', 'teamwork'),
                        new moodle_url($PAGE->url, array('confirm' => 1)), $teamwork->view_url());
echo $OUTPUT->footer();
