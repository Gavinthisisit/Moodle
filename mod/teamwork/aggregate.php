...
if ($settingsdata = $settingsform->get_data()) {
    $teamwork->aggregate_submission_grades();           // updates 'grade' in {teamwork_submissions}
    $evaluator->update_grading_grades($settingsdata);   // updates 'gradinggrade' in {teamwork_assessments}
    $teamwork->aggregate_grading_grades();              // updates 'gradinggrade' in {teamwork_aggregations}
}
