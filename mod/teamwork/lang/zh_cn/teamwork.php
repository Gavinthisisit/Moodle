...
$string['postbyfullname'] = '由<a href="{$a->url}">{$a->name}</a>评价';
...
$string['editingprojectsettings'] = '正在修改项目设置';
$string['templettitle'] = '项目名称';
$string['templetsummary'] = '项目概述';
$string['teammaxmembers'] = '团队最大人数';
$string['teamminmembers'] = '团队最小人数';
$string['teamlimit'] = '最大团队数';
$string['teamlimit_help'] = '该项目最多允许多少队伍同时选择';
$string['assessmentsettings'] = '评价设置';
$string['assessmentanonymous'] = '匿名评价';
$string['scoremin'] = '评价最小分数';
$string['scoremax'] = '评价最大分数';
$string['scoremax'] = '评价最大分数';
$string['assessfirst'] = '评价后可见';
$string['phaseadd'] = '增加一个阶段';
$string['phasename'] = '阶段名称';
$string['phasedescription'] = '阶段描述';
...
$string['teammembers'] = '团队人数: {$a->teamminmember}~{$a->teammaxmember}人';
$string['teamlimits'] = '团队数量: {$a->teamnum}/{$a->teamlimit}';
$string['myproject'] = '我的项目';
$string['teamleader'] = '队长：';
$string['teammember'] = '成员：';
$string['viewteaminfo'] = '查看团队信息';
$string['mytasks'] = '我的任务';
$string['teamforum'] = '团队阶段评价';
$string['teamlist'] = '团队列表';
$string['teamsubmission'] = '团队的提交';
$string['teammodule'] = '团队模块';
$string['completecount'] = '完成度:';
$string['activitycount'] = '活动统计:';
$string['commitcount'] = '评价情况:';
$string['feedbackcount'] = '评价回复:';
$string['workupload'] = '任务提交:';
$string['finalgrade'] = '最终得分:';
$string['unsetphase'] = '未分配阶段';
$string['activitysituation'] = '活动情况';
$string['fen'] = '{$a}分';
$string['de'] = '的第';
