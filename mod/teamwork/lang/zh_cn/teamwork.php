...
/**
 * Strings for component 'teamwork', language 'zh_cn', branch 'MOODLE_28_STABLE'
 *
 * @package   teamwork
...
$string['applystart'] = '申请开始时间';
$string['applyend'] = '申请截止时间';
...
$string['configexamplesmode'] = '团队协作中范例评价的默认模式';
$string['configgrade'] = '团队协作默认的作业最高分';
$string['configgradedecimals'] = '显示成绩时小数点后默认显示的位数。';
$string['configgradinggrade'] = '团队协作默认的评价最高分';
$string['configmaxbytes'] = '网站所有团队协作默认的最大上传文件大小（受限于课程限制和其它本地设置）';
$string['configstrategy'] = '团队协作的默认评分策略';
$string['createsubmission'] = '开始准备您的提交';
$string['datesettings'] = '日期设置';
...
$string['displaysubmissions'] = '是否在线展示作业';
...
$string['gradeitemassessment'] = '{$a->teamworkname} (评价)';
$string['gradeitemsubmission'] = '{$a->teamworkname} (作业)';
$string['gradeover'] = '覆盖作业成绩';
$string['gradereceivedfrom'] = '&lt;';
$string['gradesreport'] = '团队协作成绩报告';
...
$string['groupnoallowed'] = '您未被允许访问该团队协作中的任何一组';
...
$string['page-mod-teamwork-x'] = '任意团队协作模块页面';
$string['participant'] = '参与者';
$string['participationsettings'] = '参与设置';
$string['participationnumlimit'] = '参与数量限制';
$string['participationnumlimit_help'] = '每人最多参与的项目数';
$string['participantrevierof'] = '参与者评价谁';
$string['participantreviewedby'] = '谁评价参与者';
$string['phasesettings'] = '阶段设置';
...
$string['pluginadministration'] = '团队协作管理';
$string['pluginname'] = '团队协作';
...
$string['publishsubmission_help'] = '当团队协作关闭后，其他人仍可以看到已发布的作业。';
$string['reassess'] = '重新评价';
$string['receivedgrades'] = '收到的分数';
$string['recentassessments'] = '团队协作：';
$string['recentsubmissions'] = '团队协作的作业：';
...
$string['resetphase_help'] = '团队协作如果启用，所有的团队协作将被切换至初始设定阶段';
...
$string['subplugintype_teamworkallocation'] = '作业分配方法';
$string['subplugintype_teamworkallocation_plural'] = '作业分配方法';
$string['subplugintype_teamworkeval'] = '成绩核定方法';
$string['subplugintype_teamworkeval_plural'] = '成绩核定方法';
$string['subplugintype_teamworkform'] = '评分策略';
$string['subplugintype_teamworkform_plural'] = '评分策略';
$string['switchingphase'] = '正在切换阶段';
$string['switchphase'] = '切换阶段';
$string['switchphase10info'] = '您将切换此团队协作到<strong>设置阶段</strong>。在此阶段，用户不能修改作业和评价。教师可利用这个阶段修改团队协作的设置、评分策略或评价表格。';
$string['switchphase20info'] = '您将切换此团队协作到<strong>作业提交阶段</strong>。在此阶段学生可以上传作业（在作业访问控制日期内，如果设置了的话）。教师可分配同学间互评。';
$string['switchphase30auto'] = '在 {$a->daydatetime} ({$a->distanceday}) 之后，团队协作会自动地进入评价阶段';
$string['switchphase30info'] = '您将切换此团队协作到<strong>评价阶段</strong>。在这个阶段，评价人可以评价已分配给他们的作业（在评价访问控制日期内，如果已经设置）。';
$string['switchphase40info'] = '您将切换此团队协作到<strong>评分核定阶段</strong>。 在这个阶段，用户无法修改他们的作业和评价。教师可以使用评分核定工具计算最终成绩，并给评价人反馈。';
$string['switchphase50info'] = '您将要关闭此团队协作。这会使计算过的成绩显示在成绩单上。学生们可以查看他们的作业和对作业的评价。';
...
$string['taskintro'] = '设置此团队协作的描述';
$string['tasksubmit'] = '上传您的作业';
$string['toolbox'] = '团队协作工具箱';
$string['undersetup'] = '团队协作正在建立中。请等待，直到活动转入下一阶段。';
...
$string['userplan'] = '团队协作计划表';
$string['userplan_help'] = '团队协作计划表列出此活动的所有阶段和每个阶段的任务。高亮显示的是当前阶段。勾选标记的是已完成的任务。';
...
$string['teamwork:addinstance'] = '添加一个新的团队协作';
$string['teamwork:allocate'] = '分配作业用于评价';
$string['teamwork:editdimensions'] = '编辑评价表格';
$string['teamwork:ignoredeadlines'] = '忽略时间限制';
$string['teamwork:manageexamples'] = '管理作业范例';
$string['teamworkname'] = '团队协作名称';
$string['teamwork:overridegrades'] = '覆盖已计算的成绩';
$string['teamwork:peerassess'] = '同学间互评';
$string['teamwork:publishsubmissions'] = '发布作业';
$string['teamwork:submit'] = '上传作业';
$string['teamwork:switchphase'] = '切换阶段';
$string['teamwork:view'] = '查看团队协作';
$string['teamwork:viewallassessments'] = '查看所有评价';
$string['teamwork:viewallsubmissions'] = '查看所有作业';
$string['teamwork:viewauthornames'] = '查看作者姓名';
$string['teamwork:viewauthorpublished'] = '查看已发布作业的作者';
$string['teamwork:viewpublishedsubmissions'] = '查看已发布作业';
$string['teamwork:viewreviewernames'] = '查看评价人姓名';
