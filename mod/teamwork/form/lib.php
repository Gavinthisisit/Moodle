...
interface teamwork_strategy {
     ...
     * are saved in teamworkform_{strategyname} tables.
     *
     ...
     * If teamworkid is null, it checks for any teamwork instance. If teamworkid is provided,
