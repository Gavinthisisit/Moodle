 ...
 * @uses moodleform
 */
class teamwork_edit_strategy_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('hidden', 'teamworkid', $this->teamwork->id);        // teamworkid
        $mform->setType('teamworkid', PARAM_INT);

        $mform->addElement('hidden', 'strategy', $this->teamwork->strategy);    // strategy name
        ...
        $buttonarray[] = $mform->createElement('submit', 'saveandpreview', get_string('saveandpreview', 'teamwork'));
