 ...
 * @uses moodleform
 */
class teamwork_assessment_form extends moodleform {
    ...
    public function definition() {
        ...
        $this->teamwork = $this->_customdata['teamwork'];   // instance of the teamwork api class
        ...
        if ($this->teamwork->overallfeedbackmode and $this->is_editable()) {
            ...
            $mform->addElement('editor', 'feedbackauthor_editor', get_string('feedbackauthor', 'mod_teamwork'), null,
                $this->teamwork->overall_feedback_content_options());
            ...
            if ($this->teamwork->overallfeedbackfiles) {
                $mform->addElement('filemanager', 'feedbackauthorattachment_filemanager',
                    get_string('feedbackauthorattachment', 'mod_teamwork'), null,
                    $this->teamwork->overall_feedback_attachment_options());
            }
        }
        ...
        if (!empty($this->options['editableweight']) and $this->is_editable()) {
            ...
            $mform->addElement('select', 'weight',
                    get_string('assessmentweight', 'teamwork'), teamwork::available_assessment_weights_list());
