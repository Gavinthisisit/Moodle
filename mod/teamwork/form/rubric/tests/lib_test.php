...
require_once($CFG->dirroot . '/mod/teamwork/form/rubric/lib.php');


class teamworkform_rubric_strategy_test extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $teamwork = $this->getDataGenerator()->create_module('teamwork', array('strategy' => 'rubric', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['teamwork'][$teamwork->id];
        $this->teamwork = new teamwork($teamwork, $cm, $course);
        $this->strategy = new testable_teamwork_rubric_strategy($this->teamwork);
 ...
 */
class testable_teamwork_rubric_strategy extends teamwork_rubric_strategy {
