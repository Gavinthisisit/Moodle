 ...
 */
class backup_teamworkform_comments_subplugin extends backup_subplugin {
    ...
    protected function define_teamwork_subplugin_structure() {
        ...
        $subplugindimension = new backup_nested_element('teamworkform_comments_dimension', array('id'), array(
        ...
        $subplugindimension->set_source_table('teamworkform_comments', array('teamworkid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('teamworkform_comments', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('teamworkform_comments_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('teamworkform_comments_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('teamworkform_comments_grade');
    }
