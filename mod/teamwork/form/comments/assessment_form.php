 ...
 * @uses moodleform
 */
class teamwork_comments_assessment_form extends teamwork_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'teamworkform_comments', $i+1);
            ...
            // comment
            $label = get_string('dimensioncomment', 'teamworkform_comments');
