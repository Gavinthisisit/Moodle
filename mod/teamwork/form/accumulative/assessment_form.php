 ...
 * @uses moodleform
 */
class teamwork_accumulative_assessment_form extends teamwork_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'teamworkform_accumulative', $i+1);
            ...
            $label = get_string('dimensiongrade', 'teamworkform_accumulative');
            ...
            $mform->addRule(array('grade__idx_' . $i, 'minusone') , get_string('mustchoosegrade', 'teamworkform_accumulative'), 'compare', 'gt');

            // comment
            $label = get_string('dimensioncomment', 'teamworkform_accumulative');
