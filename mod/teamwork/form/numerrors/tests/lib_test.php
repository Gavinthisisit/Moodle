...
require_once($CFG->dirroot . '/mod/teamwork/form/numerrors/lib.php');


class teamworkform_numerrors_strategy_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $teamwork = $this->getDataGenerator()->create_module('teamwork', array('strategy' => 'numerrors', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['teamwork'][$teamwork->id];
        $this->teamwork = new teamwork($teamwork, $cm, $course);
        $this->strategy = new testable_teamwork_numerrors_strategy($this->teamwork);
    }
 ...
 */
class testable_teamwork_numerrors_strategy extends teamwork_numerrors_strategy {
