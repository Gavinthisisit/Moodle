 ...
 */
class backup_teamworkform_numerrors_subplugin extends backup_subplugin {
    ...
    protected function define_teamwork_subplugin_structure() {
        ...
        $subpluginmap = new backup_nested_element('teamworkform_numerrors_map', array('id'), array(
            'nonegative', 'grade'));
        $subplugindimension = new backup_nested_element('teamworkform_numerrors_dimension', array('id'), array(
        ...
        $subpluginmap->set_source_table('teamworkform_numerrors_map', array('teamworkid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('teamworkform_numerrors', array('teamworkid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('teamworkform_numerrors', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('teamworkform_numerrors_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('teamworkform_numerrors_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('teamworkform_numerrors_grade');
    }
