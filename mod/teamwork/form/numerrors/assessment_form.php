 ...
 * @uses moodleform
 */
class teamwork_numerrors_assessment_form extends teamwork_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'teamworkform_numerrors', $i+1);
            ...
            $label = get_string('dimensiongrade', 'teamworkform_numerrors');
            ...
            ), 'group_grade__idx_' . $i, get_string('yourassessment', 'teamwork'), '<br />', false);
            $mform->addRule('group_grade__idx_' . $i, get_string('required'), 'required');

            // comment
            $label = get_string('dimensioncomment', 'teamworkform_numerrors');
