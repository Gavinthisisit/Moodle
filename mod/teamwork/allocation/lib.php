 ...
 * teamwork_assessments table.
 */
interface teamwork_allocator {
     ...
     *
     * @param stdClass $wsoutput teamwork module renderer can be used
 ...
 */
class teamwork_allocation_result implements renderable {
    ...
    /** @var teamwork_allocator the instance of the allocator that produced this result */
    protected $allocator;
     ...
     *
     * @param teamwork_allocator $allocator
     */
    public function __construct(teamwork_allocator $allocator) {
