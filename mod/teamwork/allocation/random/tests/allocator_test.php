...
require_once($CFG->dirroot . '/mod/teamwork/allocation/random/lib.php');


class teamworkallocation_random_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $this->allocator = new testable_teamwork_random_allocator($this->teamwork);
    }
 ...
 */
class testable_teamwork_random_allocator extends teamwork_random_allocator {
