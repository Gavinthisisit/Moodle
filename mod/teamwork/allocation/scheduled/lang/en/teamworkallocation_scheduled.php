...
/**
 * Strings for the Teamwork's scheduled allocator
 *
...
$string['scheduledallocationsettings_help'] = 'If enabled, the scheduled allocation method will automatically allocate submissions for the assessment at the end of the submission phase. The end of the phase can be defined in the teamwork setting \'Submissions deadline\'.
...
Note that the scheduled allocation is *not* executed if you manually switch the teamwork into the assessment phase before the submissions deadline. You have to allocate submissions yourself in that case. The scheduled allocation method is particularly useful when used together with the automatic phase switching feature.';
...
$string['resultfaileddeadline'] = 'Teamwork does not have the submissions deadline defined';
$string['resultfailedphase'] = 'Teamwork not in the submission phase';
