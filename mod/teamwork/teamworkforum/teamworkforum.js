...
function teamworkforum_produce_subscribe_link(teamworkforumid, backtoindex, ltext, ltitle) {
    var elementid = "subscriptionlink";
    var subs_link = document.getElementById(elementid);
    if(subs_link){
        subs_link.innerHTML = "<a title='"+ltitle+"' href='"+M.cfg.wwwroot+"/mod/teamworkforum/subscribe.php?id="+teamworkforumid+backtoindex+"&amp;sesskey="+M.cfg.sesskey+"'>"+ltext+"<\/a>";
    }
}

function teamworkforum_produce_tracking_link(teamworkforumid, ltext, ltitle) {
    var elementid = "trackinglink";
    var subs_link = document.getElementById(elementid);
    if(subs_link){
        subs_link.innerHTML = "<a title='"+ltitle+"' href='"+M.cfg.wwwroot+"/mod/teamworkforum/settracking.php?id="+teamworkforumid+"&amp;sesskey="+M.cfg.sesskey+"'>"+ltext+"<\/a>";
    }
}
