...
/**
 * The mod_teamworkforum user report viewed event.
 *
...
/**
 * The mod_teamworkforum user report viewed event class.
 *
...
class user_report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserreportviewed', 'mod_teamworkforum');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/mod/teamworkforum/user.php', array('id' => $this->relateduserid,
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'teamworkforum', 'user report', $logurl, $this->relateduserid);
    }
