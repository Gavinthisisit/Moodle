...
/**
 * The mod_teamworkforum assessable uploaded event.
 *
...
/**
 * The mod_teamworkforum assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has posted content in the teamworkforum post with id '$this->objectid' " .
            "in the discussion '{$this->other['discussionid']}' located in the teamworkforum with course module id " .
    ...
    protected function get_legacy_eventdata() {
        ...
        $eventdata->modulename   = 'teamworkforum';
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_teamworkforum');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/teamworkforum/discuss.php', array('d' => $this->other['discussionid'], 'parent' => $this->objectid));
    }
