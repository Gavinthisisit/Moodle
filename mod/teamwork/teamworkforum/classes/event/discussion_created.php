...
/**
 * The mod_teamworkforum discussion created event.
 *
...
/**
 * The mod_teamworkforum discussion created event class.
 *
...
class discussion_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created the discussion with id '$this->objectid' in the teamworkforum " .
    ...
    public static function get_name() {
        return get_string('eventdiscussioncreated', 'mod_teamworkforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'teamworkforum', 'add discussion', $logurl, $this->objectid, $this->contextinstanceid);
    }
