...
/**
 * The mod_teamworkforum post updated event.
 *
...
/**
 * The mod_teamworkforum post updated event class.
 *
...
class post_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostupdated', 'mod_teamworkforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'teamworkforum', 'update post', $logurl, $this->objectid, $this->contextinstanceid);
    }
