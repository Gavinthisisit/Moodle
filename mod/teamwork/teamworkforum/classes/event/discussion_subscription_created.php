...
/**
 * The mod_teamworkforum discussion_subscription created event.
 *
...
/**
 * The mod_teamworkforum discussion_subscription created event class.
 *
 * @property-read array $other {
 *      Extra information about the event.
 *
 *      - int teamworkforumid: The id of the teamworkforum which the discussion is in.
...
class discussion_subscription_created extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'teamworkforum_discussion_subs';
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' subscribed the user with id '$this->relateduserid' to the discussion " .
            " with id '{$this->other['discussion']}' in the teamworkforum with the course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussionsubscriptioncreated', 'mod_teamworkforum');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/teamworkforum/subscribe.php', array(
            'id' => $this->other['teamworkforumid'],
