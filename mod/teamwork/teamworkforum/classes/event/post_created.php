...
/**
 * The mod_teamworkforum post created event.
 *
...
/**
 * The mod_teamworkforum post created event class.
 *
...
class post_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostcreated', 'mod_teamworkforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'teamworkforum', 'add post', $logurl, $this->other['teamworkforumid'], $this->contextinstanceid);
    }
