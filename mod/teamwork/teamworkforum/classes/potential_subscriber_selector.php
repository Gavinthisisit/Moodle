...
/**
 * A user selector control for potential subscribers to the selected teamworkforum
 * @package   mod_teamworkforum
 * @copyright 2009 Sam Hemelryk
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_teamworkforum_potential_subscriber_selector extends mod_teamworkforum_subscriber_selector_base {
    /**
     * If set to true EVERYONE in this course is force subscribed to this teamworkforum
     * @var bool
     */
    ...
    public function find_users($search) {
        ...
        $cm = get_coursemodule_from_instance('teamworkforum', $this->teamworkforumid);
        ...
        if ($this->forcesubscribed) {
            return array(get_string("existingsubscribers", 'teamworkforum') => $availableusers);
        } else {
            return array(get_string("potentialsubscribers", 'teamworkforum') => $availableusers);
        }
    }
    ...
    /**
     * Sets this teamworkforum as force subscribed or not
     */
