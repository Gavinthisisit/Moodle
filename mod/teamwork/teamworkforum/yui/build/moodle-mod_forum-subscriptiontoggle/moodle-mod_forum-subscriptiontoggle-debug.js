YUI.add('moodle-mod_teamworkforum-subscriptiontoggle', function (Y, NAME) {
 ...
 * @main       moodle-mod_teamworkforum-subscriptiontoggle
 */

/**
 * @namespace M.mod_teamworkforum
...
var LOGNAME = 'moodle-mod_teamworkforum-subscriptiontoggle';
...
Y.extend(SubscriptionToggle, Y.Base, {
    ...
    _toggleSubscription: function(e) {
        ...
        Y.io(this.get('uri'), {
            data: {
                ...
                teamworkforumid: clickedLink.getData('teamworkforumid'),
    ...
    ATTRS: {
         ...
         * @attribute uri
         * @type String
         * @default M.cfg.wwwroot + '/mod/teamworkforum/subscribe_ajax.php'
         */
        uri: {
            value: M.cfg.wwwroot + '/mod/teamworkforum/subscribe_ajax.php'
        }
    }
});

var NS = Y.namespace('M.mod_teamworkforum.subscriptiontoggle');
