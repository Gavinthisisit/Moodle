...
Feature: A user can control their own subscription preferences for a discussion
  ...
  Scenario: An optional teamworkforum can have discussions subscribed to
    ...
    Then I should see "Subscribe to this teamworkforum"
    ...
    And I should see "Subscribe to this teamworkforum"
    ...
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"
    And I follow "Subscribe to this teamworkforum"
    And I follow "Continue"
    And I should see "Unsubscribe from this teamworkforum"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject two" "table_row"
    And I follow "Unsubscribe from this teamworkforum"
    And I follow "Continue"
    And I should see "Subscribe to this teamworkforum"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"

  Scenario: An automatic subscription teamworkforum can have discussions unsubscribed from
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test teamworkforum name |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
    ...
    And I follow "Course 1"
    And I follow "Test teamworkforum name"
    Then I should see "Unsubscribe from this teamworkforum"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject two" "table_row"
    And I click on "You are subscribed to this discussion. Click to unsubscribe." "link" in the "Test post subject one" "table_row"
    And I follow "Continue"
  ...
  Scenario: A user does not lose their preferences when a teamworkforum is switch from optional to automatic
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test teamworkforum name |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
    ...
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject two" "table_row"
    When I follow "Unsubscribe from this teamworkforum"
    And I follow "Continue"
    Then I should see "Subscribe to this teamworkforum"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"
  ...
  Scenario: An optional teamworkforum prompts a user to subscribe to a discussion when posting unless they have already chosen not to subscribe
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test teamworkforum name |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
    ...
    And I follow "Test teamworkforum name"
    And I should see "Subscribe to this teamworkforum"
    And I reply "Test post subject one" post from "Test teamworkforum name" teamworkforum with:
      | Subject | Reply 1 to discussion 1 |
      | Message | Discussion contents 1, second message |
      | Discussion subscription | 1 |
    And I reply "Test post subject two" post from "Test teamworkforum name" teamworkforum with:
      | Subject | Reply 1 to discussion 1 |
      | Message | Discussion contents 1, second message |
  ...
  Scenario: An automatic teamworkforum prompts a user to subscribe to a discussion when posting unless they have already chosen not to subscribe
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test teamworkforum name |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
 ...
 Scenario: A user who is not logged in should not be able to subscribe to a discussion
   ...
   And I add a new discussion to "Test teamworkforum name" teamworkforum with:
     ...
     | Message | Test post message one |
   And I log out
   When I follow "Test teamworkforum name"
   Then "You are not subscribed to this discussion. Click to subscribe." "link" should not exist in the "Test post subject one" "table_row"
   And "You are subscribed to this discussion. Click to unsubscribe." "link" should not exist in the "Test post subject one" "table_row"
   And I follow "Test post subject one"
   And "You are not subscribed to this discussion. Click to subscribe." "link" should not exist
