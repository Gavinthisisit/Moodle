...
Feature: A user can control their default discussion subscription settings
  ...
  Scenario: Creating a new discussion in an optional teamworkforum follows user preferences
  ...
  Scenario: Replying to an existing discussion in an optional teamworkforum follows user preferences
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test teamworkforum name |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
  ...
  Scenario: Creating a new discussion in an automatic teamworkforum follows teamworkforum subscription
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test teamworkforum name |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
  ...
  Scenario: Replying to an existing discussion in an automatic teamworkforum follows teamworkforum subscription
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test teamworkforum name |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
  ...
  Scenario: Replying to an existing discussion in an automatic teamworkforum which has been unsubscribed from follows user preferences
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test teamworkforum name |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
