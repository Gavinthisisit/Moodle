...
Feature: Posting to all groups in a visible group discussion is restricted to users with access to all groups
  In order to post to all groups in a teamworkforum with visible groups
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | teamworkforum      | Standard teamworkforum name    | Standard teamworkforum description    | C1     | groups       | 2         |
