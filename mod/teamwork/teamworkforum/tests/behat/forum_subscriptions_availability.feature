...
Feature: As a teacher I need to see an accurate list of subscribed users
  In order to see who is subscribed to a teamworkforum
  As a teacher
  ...
  @javascript
  Scenario: A forced teamworkforum lists all subscribers
  ...
  Scenario: A forced teamworkforum does not allow to edit the subscribers
    When I add a "Forum" to section "1" and I fill the form with:
  ...
  Scenario: A forced and hidden teamworkforum lists only teachers
    When I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Forced Forum 2 |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
  ...
  @javascript
  Scenario: An automatic teamworkforum lists all subscribers
    When I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Forced Forum 1 |
      | Forum type        | Standard teamworkforum for general use |
      | Description       | Test teamworkforum description |
