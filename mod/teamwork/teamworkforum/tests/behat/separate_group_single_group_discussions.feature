...
Feature: Posting to groups in a separate group discussion when restricted to groupings
  In order to post to groups in a teamworkforum with separate groups and groupings
  As a teacher
  ...
  Background:
    ...
    And I add a "Forum" to section "1" and I fill the form with:
      | Forum name  | Multiple groups teamworkforum             |
      | Forum type  | Standard teamworkforum for general use    |
      | Description | Standard teamworkforum description        |
      | Group mode  | Separate groups                   |
      | Grouping    | G1                                |
    And I add a "Forum" to section "1" and I fill the form with:
      | Forum name  | Single groups teamworkforum               |
      | Forum type  | Standard teamworkforum for general use    |
      | Description | Standard teamworkforum description        |
      | Group mode  | Separate groups                   |
      | Grouping    | G2                                |
  ...
  Scenario: Teacher with accessallgroups can post in all groups
    ...
    And I follow "Course 1"
    And I follow "Multiple groups teamworkforum"
    ...
    And I follow "Course 1"
    And I follow "Single groups teamworkforum"
