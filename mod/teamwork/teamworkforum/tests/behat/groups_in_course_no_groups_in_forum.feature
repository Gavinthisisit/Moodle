...
Feature: Forums in 'No groups' mode allow posting to All participants for all users
  In order to post to a teamworkforum in 'No groups' mode, which is in course which has groups
  As any user
  I need to post
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | teamworkforum      | Standard teamworkforum name    | Standard teamworkforum description    | C1     | nogroups     | 0         |
