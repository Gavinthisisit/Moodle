...
/**
 * The mod_teamwork assessable uploaded event.
 *
...
/**
 * The mod_teamwork assessable uploaded event class.
 *
 * @package    mod_teamwork
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has uploaded the submission with id '$this->objectid' " .
            "to the teamwork activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_teamwork');
    }
