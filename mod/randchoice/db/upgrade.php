...
function xmldb_randchoice_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2014051201) {
        ...
        // Define field allowmultiple to be added to randchoice.
        $table = new xmldb_table('randchoice');
        ...
        upgrade_mod_savepoint(true, 2014051201, 'randchoice');
    }
    ...
    if ($oldversion < 2014111001) {
        ...
        // Define field showpreview to be added to randchoice.
        $table = new xmldb_table('randchoice');
        ...
        // Choice savepoint reached.
        upgrade_mod_savepoint(true, 2014111001, 'randchoice');
    }

    if ($oldversion < 2014111002) {

        // Define field includeinactive to be added to randchoice.
        $table = new xmldb_table('randchoice');
        ...
        // Choice savepoint reached.
        upgrade_mod_savepoint(true, 2014111002, 'randchoice');
    }
