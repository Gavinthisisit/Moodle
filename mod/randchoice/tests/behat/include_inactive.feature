...
Feature: Include responses from inactive users
  In order to view responses from inactive or suspended users in randchoice results
  As a teacher
  I need to enable the randchoice include inactive option
  ...
  @javascript
  Scenario: Enable the randchoice include inactive option and check that responses from inactive students are visible
    ...
    And I follow "Course 1"
    And I choose "Option 2" from "Choice name" randchoice activity
    And I log out
    And I log in as "student3"
    And I follow "Course 1"
    And I choose "Option 3" from "Choice name" randchoice activity
    And I log out
    And the following "course enrolments" exist:
  ...
  @javascript
  Scenario: Disable the randchoice include inactive option and check that responses from inactive students are not visible
    Given I add a "Choice" to section "1" and I fill the form with:
      | Choice name | Choice name |
      | Description | Choice Description |
      | option[0] | Option 1 |
