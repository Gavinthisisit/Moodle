@mod @mod_randchoice
Feature: Limit randchoice responses
  In order to restrict students from selecting a response more than a specified number of times
  As a teacher
  I need to limit the randchoice responses

  @javascript
  Scenario: Limit the number of responses allowed for a randchoice activity and verify the result as students
