@mod @mod_randchoice
Feature: A teacher can choose whether to publish randchoice activity results anonymously or showing names
  ...
  Scenario: Publish full results
    Given I add a "Choice" to section "1" and I fill the form with:
      ...
      | option[1] | Option 2 |
      | Publish results | Always show results to students |
      | Privacy of results | Publish full results, showing names and their randchoices |
    And I log out
    And I log in as "student1"
    And I follow "Course 1"
    And I choose "Option 1" from "Choice 1" randchoice activity
