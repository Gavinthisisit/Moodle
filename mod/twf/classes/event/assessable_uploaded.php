...
/**
 * The mod_twf assessable uploaded event.
 *
 * @package    mod_twf
...
/**
 * The mod_twf assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has posted content in the twf post with id '$this->objectid' " .
            "in the discussion '{$this->other['discussionid']}' located in the twf with course module id " .
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_twf');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/twf/discuss.php', array('d' => $this->other['discussionid'], 'parent' => $this->objectid));
    }
