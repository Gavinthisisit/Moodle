...
/**
 * The mod_twf user report viewed event.
 *
 * @package    mod_twf
...
/**
 * The mod_twf user report viewed event class.
 *
...
class user_report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserreportviewed', 'mod_twf');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/mod/twf/user.php', array('id' => $this->relateduserid,
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'twf', 'user report', $logurl, $this->relateduserid);
    }
