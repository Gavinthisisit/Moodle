...
/**
 * A user selector control for potential subscribers to the selected twf
 * @package   mod_twf
 * @copyright 2009 Sam Hemelryk
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_twf_potential_subscriber_selector extends mod_twf_subscriber_selector_base {
    /**
     * If set to true EVERYONE in this course is force subscribed to this twf
     * @var bool
     */
    ...
    public function find_users($search) {
        ...
        if ($this->forcesubscribed) {
            return array(get_string("existingsubscribers", 'twf') => $availableusers);
        } else {
            return array(get_string("potentialsubscribers", 'twf') => $availableusers);
        }
    }
    ...
    /**
     * Sets this twf as force subscribed or not
     */
