...
/**
 * Strings for component 'twf', language 'zh_cn', branch 'MOODLE_29_STABLE'
 *
 * @package   twf
...
$string['alltwfs'] = '全部评价区';
$string['allowdiscussions'] = '允许 {$a} 在此评价区发帖吗?';
$string['allowsallsubscribe'] = '每个人可以选择是否订阅该评价区帖子';
$string['allowsdiscussions'] = '该评价区允许每个人发起新话题。';
$string['allsubscribe'] = '订阅所有评价区';
$string['allunsubscribe'] = '退订所有评价区';
...
$string['blockafter_help'] = '此项设置决定用户在指定的时长内最多允许发几个帖子。有mod/twf:postwithoutthrottling权限的用户不受此限。';
$string['blockperiod'] = '阻塞统计周期';
$string['blockperioddisabled'] = '不阻塞';
$string['blockperiod_help'] = '学生如果在指定的时长内发了达到指定数量的帖子，会被阻止继续发帖。有mod/twf:postwithoutthrottling权限的用户不受此限。';
$string['blogtwf'] = '博客形式的标准评价区';
$string['bynameondate'] = '由 {$a->name} 发表于 {$a->date}';
$string['cannotadd'] = '不能向此评价区添加此话题';
$string['cannotadddiscussion'] = '在此评价区新建话题必须是组内成员。';
$string['cannotadddiscussionall'] = '您没有向所有人添加新话题的权限';
$string['cannotaddsubscriber'] = '不能向此评价区添加id为{$a}的订阅人！';
$string['cannotaddteachertwfto'] = '不能在课程的第0节添加转换过的教师评价区';
$string['cannotcreatediscussion'] = '不能建立新话题';
$string['cannotcreateinstanceforteacher'] = '不能建立新的教师评价区模块实例';
$string['cannotdeletepost'] = '您不能删除此帖！';
$string['cannoteditposts'] = '您不能编辑他人的帖子！';
$string['cannotfinddiscussion'] = '本评价区中找不到这个话题';
$string['cannotfindfirstpost'] = '找不到评价区的第一个帖子';
$string['cannotfindorcreatetwf'] = '无法找到或建立网站的主新闻评价区';
$string['cannotfindparentpost'] = '无法找到帖子{$a}的祖先';
$string['cannotmovefromsingletwf'] = '不能从单个话题评价区移动话题';
$string['cannotmovenotvisible'] = '评价区不可见';
$string['cannotmovetonotexist'] = '您不能移动到那个评价区 - 它不存在';
$string['cannotmovetonotfound'] = '课程中找不到目标评价区';
$string['cannotmovetosingletwf'] = '不能将话题移动到单个简单话题评价区';
$string['cannotpurgecachedrss'] = '无法清理目标或源评价区的RSS种子缓存 - 检查你的文件permissionstwfs';
$string['cannotremovesubscriber'] = '不能从此评价区删除id为{$a}的订阅人！';
$string['cannotreply'] = '您不能回复此帖';
$string['cannotsplit'] = '此评价区的话题不能被分割';
$string['cannotsubscribe'] = '抱歉，您必须是小组成员才能订阅。';
$string['cannottrack'] = '无法停止对该评价区的跟踪';
$string['cannotunsubscribe'] = '不能取消您对该评价区的订阅';
...
$string['configenablerssfeeds'] = '这个选项使所有评价区支持 RSS 种子。您仍需手工激活每一个评价区配置中的 RSS 种子选项。';
$string['configenabletimedposts'] = '如果您想在评价区发帖时可以设置显示周期，将此设置为“是”（试验性，未完全测试）';
$string['configlongpost'] = '超过该长度(字符个数，不含 HTML)的帖子被认为是长帖子。在网站首页、社区格式的课程页或用户资料显示的帖子会被精简到一个自然的中断位置，其长度在 twf_shortpost 和 twf_longpost 之间。';
$string['configmanydiscussions'] = '每页显示的讨论主题数';
$string['configmaxattachments'] = '每个帖子缺省允许的最大附件数。';
$string['configmaxbytes'] = '缺省的所有评价区最大附件尺寸(受课程设置和本地配置的限制)';
$string['configoldpostdays'] = '帖子在多少天后应当被视为已读。';
$string['configreplytouser'] = '当通过email发送评价区中的帖子时，是否可以包含用户的email地址，以便收信人可以直接而不是通过评价区回复发帖人？即使设置为“是”，用户仍可以在他们的个人资料里设置email地址为保密。';
...
$string['confirmsubscribe'] = '您确定要订阅评价区“{$a}”吗？';
$string['confirmunsubscribe'] = '您确定要取消订阅评价区“{$a}”吗？';
...
$string['digestmailheader'] = '这是 {$a->sitename} 评价区的每日新帖摘要。要修改您的关于评价区的偏好，请访问 {$a->userprefs}。';
$string['digestmailpost'] = '更改评价区摘要的默认设置';
$string['digestmailprefs'] = '您的用户信息';
$string['digestmailsubject'] = '{$a}: 评价区摘要';
...
$string['discussionmovedpost'] = '此话题已经移到</a>评价区<a href="{$a->twfhref}">{$a->twfname}</a>中的<a href="{$a->discusshref}">这里了</a>';
...
$string['displayend_help'] = '<p align="center"><b>评价区显示时期</b></p>

<p>可以选择是否将评价区帖子在一定的时间显示。</p>
...
$string['displaystart_help'] = '<p align="center"><b>评价区显示时期</b></p>
...
$string['emaildigesttype_help'] = '你从评价区收到的通知，可分成四种类型：
*默认 -- 会根据你在个人资料中关于帖子摘要的设定；
*没有摘要 -- 每个新帖子，你都会收到一封邮件；
*摘要/内容 -- 每个新帖子，你都会收到一封包含帖子全文的邮件；
*摘要/主题 -- 每个新帖子，你都会收到一封含摘要和主题的邮件。';
$string['emaildigestupdated'] = '这是发送帖子摘要的选项，已经把 \'{$a->twf}\'更改为 \'{$a->maildigesttitle}\' 。 {$a->maildigestdescription}';
$string['emaildigestupdated_default'] = '\'{$a->twf}\'评价区将使用你在资料中的\'{$a->maildigesttitle}\'默认设置。{$a->maildigestdescription}';
...
$string['eventassessableuploaded'] = '某些已经发到评价区';
$string['everyonecanchoose'] = '任何人均可选择订阅';
$string['everyonecannowchoose'] = '现在任何人均可选择订阅';
$string['everyoneisnowsubscribed'] = '现在所有人都订阅了该评价区';
$string['everyoneissubscribed'] = '所有人都订阅了该评价区';
$string['existingsubscribers'] = '个订阅者';
$string['exportdiscussion'] = '导出整个话题';
$string['forcedreadtracking'] = '强制阅读跟踪';
$string['forcedreadtracking_desc'] = '允许评价区设置为“强制阅读跟踪”，可能导致某些课程运行效能降低，特别是在含有多个评价区和帖子的课程中。若以后关闭此选项，以前的设置为“强制的”都会更改为“自行选择”。';
$string['forcesubscribed'] = '该评价区强制每个人都订阅';
$string['twf'] = '评价区';
$string['twf:addinstance'] = '添加新评价区';
$string['twf:addnews'] = '发布新闻';
$string['twf:addquestion'] = '提问';
$string['twf:allowforcesubscribe'] = '允许强制订阅';
$string['twfauthorhidden'] = '作者(隐藏)';
$string['twfblockingalmosttoomanyposts'] = '您已经达到发帖的极限。在过去的 {$a->blockperiod} 里，您已经发表了 {$a->numposts} 个帖子。这个极限是 {$a->blockafter} 个帖子。';
$string['twfbodyhidden'] = '您不能看这个帖子，可能因为您还没有参与到这个话题中，或者还未达到帖子的最长编辑时限，或者讨论还未开始或已经结束。';
$string['twf:createattachment'] = '上传附件';
$string['twf:deleteanypost'] = '删除任何帖子（任何时间）';
$string['twf:deleteownpost'] = '删除自己的帖子（在截止时间之内）';
$string['twf:editanypost'] = '编辑任何帖子';
$string['twf:exportdiscussion'] = '导出整个话题';
$string['twf:exportownpost'] = '导出自己的帖子';
$string['twf:exportpost'] = '导出帖子';
$string['twfintro'] = '评价区简介';
$string['twf:managesubscriptions'] = '管理订阅';
$string['twf:movediscussions'] = '移动话题';
$string['twfname'] = '评价区名称';
$string['twfposts'] = '评价区帖子';
$string['twf:postwithoutthrottling'] = '不受发帖阈值限制';
$string['twf:rate'] = '评价帖子';
$string['twf:replynews'] = '回复新闻';
$string['twf:replypost'] = '回复帖子';
$string['twfs'] = '评价区';
$string['twf:splitdiscussions'] = '分割话题';
$string['twf:startdiscussion'] = '开启新的话题';
$string['twfsubjecthidden'] = '主题(隐藏)';
$string['twftracked'] = '跟踪未读帖子';
$string['twftrackednot'] = '不跟踪未读帖子';
$string['twftype'] = '评价区类型';
$string['twftype_help'] = '有5种评价区类型：

* 单个简单话题 - 一个简单的话题，每个人都可以回复
* 每人发布一个话题 - 每名学生都可以发布一个（也只能一个）新话题，所有人都可以回复。
* 提问与回答评价区 - 学生必须先发表他的见解，才能看到别人的帖子。
* 博客形式的标准评价区 - 一个开放的评价区，任何人在任何时间都可以发起一个新话题。所有话题都显示在一个页面中。每个话题都有一个“讨论此话题”的链接
* 一般用途的标准评价区 - 一个开放的评价区，任何人在任何时间都可以发起一个新话题。';
$string['twf:viewallratings'] = '查看所有由个人给出的原始评分';
$string['twf:viewanyrating'] = '查看任何人的总分';
$string['twf:viewdiscussion'] = '阅读话题';
$string['twf:viewhiddentimedposts'] = '阅读隐藏的定时帖子';
$string['twf:viewqandawithoutposting'] = '始终可看提问帖和回答帖';
$string['twf:viewrating'] = '查看自己的总分';
$string['twf:viewsubscribers'] = '查看订阅者';
$string['generaltwf'] = '一般用途的标准评价区';
$string['generaltwfs'] = '普通评价区';
$string['hiddentwfpost'] = '隐藏评价区帖子内容';
$string['intwf'] = '在 {$a} 里';
$string['introblog'] = '本评价区的帖子自动拷贝自课程的博客用户。那些博客将不能再使用。';
$string['intronews'] = '普通新闻与通告';
$string['introsocial'] = '开放的评价区，可以随便聊聊';
$string['introteacher'] = '教师专用评价区';
...
<p>附件的文件尺寸是可以限制的，创建评价区的人可以设置它。</p>

<p>有时，您可以提交一个比这个尺寸大的文件，但这个文件不会被保存下来，且您会看到一个错误信息。</p>';
$string['maxtimehaspassed'] = '很抱歉，编辑该帖的时间限制({$a})已过！';
$string['message'] = '正文';
$string['messageprovider:digests'] = '订阅评价区摘要';
$string['messageprovider:posts'] = '订阅的评价区帖子';
...
$string['modulename'] = '评价区';
$string['modulename_help'] = '在评价区模块用户可以进行异步的讨论。';
$string['modulenameplural'] = '评价区';
$string['more'] = '更多';
$string['movedmarker'] = '（移动）';
$string['movethisdiscussionto'] = '将此论题移至...';
$string['mustprovidediscussionorpost'] = '导出时，您必须提供一个话题id或帖子id';
$string['myprofileotherdis'] = '论坛评价区';
$string['myprofileowndis'] = '我的论坛评价区';
$string['namenews'] = '新闻评价区';
$string['namenews_help'] = '新闻评价区，是一个用来发布消息的特别评价区，在课程建立时会被自动创建。每门课程只能有一个新闻评价区。只有教师和管理员可以在新闻评价区发帖。“最近新闻”版块会显示新闻评价区最近的讨论。';
$string['namesocial'] = '公众评价区';
$string['nameteacher'] = '教师评价区';
$string['newtwfposts'] = '新帖子';
$string['noattachments'] = '此帖没有附件';
$string['nodiscussions'] = '该评价区尚无讨论话题';
...
$string['nopermissiontosubscribe'] = '您没有查看评价区订阅者的权限';
$string['nopermissiontoview'] = '您没有查看此帖子的权限';
$string['noposttwf'] = '很抱歉，您不能在此评价区发帖';
$string['noposts'] = '没有帖子';
$string['nopostsmadebyuser'] = '{$a}没有发过贴';
$string['nopostsmadebyyou'] = '您还没发过任何帖子';
$string['noquestions'] = '此评价区尚无人提问';
$string['nosubscribers'] = '尚无人订阅此评价区';
$string['notexists'] = '话题已不存在';
$string['nothingnew'] = '{$a} 中没有什么新东西';
$string['notingroup'] = '很抱歉, 您需要是一个组的成员才能浏览这个评价区。';
$string['notinstalled'] = '评价区模块没有被安装';
$string['notpartofdiscussion'] = '此帖不是话题的一部分';
$string['notracktwf'] = '不跟踪未读帖子';
$string['noviewdiscussionspermission'] = '您无权查看这个评价区的话题';
$string['nowallsubscribed'] = '已订阅 {$a} 中的所有评价区。';
$string['nowallunsubscribed'] = '已退订 {$a} 中的所有评价区';
$string['nownotsubscribed'] = '{$a->name}将不再收到“{$a->twf}”新帖子的通知';
$string['nownottracking'] = '{$a->name} 不再跟踪“{$a->twf}”了。';
$string['nowsubscribed'] = '“{$a->twf}”有新帖子会通知{$a->name}';
$string['nowtracking'] = '{$a->name} 现在跟踪“{$a->twf}”。';
...
$string['page-mod-twf-discuss'] = '评价区模块话题页';
$string['page-mod-twf-view'] = '评价区模块主页';
$string['page-mod-twf-x'] = '任意评价区模块页面';
$string['parent'] = '显示父帖子';
$string['parentofthispost'] = '该帖的父帖';
$string['pluginadministration'] = '评价区管理';
$string['pluginname'] = '评价区';
...
$string['qandatwf'] = '问题及解答评价区';
$string['qandanotify'] = '这是一个问题和解答评价区。为了能看到其他人的回应，您首先需要发表您的解答';
$string['re'] = '回复:';
...
$string['reply'] = '回复';
$string['replytwf'] = '回复到评价区上';
$string['replytouser'] = '在回复中使用Email地址';
$string['resettwfs'] = '删除哪类评价区类型中帖子';
$string['resettwfsall'] = '删除所有的帖子';
$string['resetsubscriptions'] = '删除所有评价区订阅';
$string['resettrackprefs'] = '删除评价区中的所有跟踪参数';
$string['rssarticles'] = 'RSS最近文章数';
$string['rssarticles_help'] = '<p align="center"><b>在RSS中包含的文章数目</b></p>

<p>这个选项允许您设置在RSS种子中包含的文章数目。</p>

<p>对于大多数评价区来说，5至20之间就可以了，如果您的评价区用户真的很多，可以设大一些。</p>';
$string['rsssubscriberssdiscussions'] = '话题的RSS种子';
$string['rsssubscriberssposts'] = '帖子的RSS种子';
$string['rsstype'] = '本活动的RSS种子';
$string['rsstype_help'] = '<p align="center"><b>评价区的RSS种子</b></p>

<p>这个选项允许您开启这个评价区的RSS种子。</p>
...
$string['searchtwfintro'] = '请在下面的一个或多个项目中输入搜索词条：';
$string['searchtwfs'] = '搜索评价区';
...
$string['searchwhichtwfs'] = '选择要搜索哪个评价区';
$string['searchwords'] = '这些文字可以在帖子的任何位置出现';
$string['seeallposts'] = '查看此用户发表的全部帖子';
$string['shortpost'] = '短帖';
$string['showsubscribers'] = '显示/修改订阅者';
$string['singletwf'] = '单个简单话题';
$string['smallmessage'] = '{$a->user}在{$a->twfname}发帖';
$string['startedby'] = '发起人';
$string['subject'] = '主题';
$string['subscribe'] = '订阅此评价区';
$string['subscribeall'] = '为所有人订阅此评价区';
$string['subscribed'] = '订阅';
$string['subscribeenrolledonly'] = '抱歉，只有已选课用户才能订阅评价区帖子通知。';
$string['subscribenone'] = '让所有人退订此评价区';
$string['subscribers'] = '订阅者';
$string['subscribersto'] = '订阅“{$a}”的用户';
$string['subscribestart'] = '通过email发评价区帖子给我';
$string['subscribestop'] = '我不想通过email接收评价区帖子';
...
$string['subscription_help'] = '如果您订阅了一个评价区，那意味着您将通过email收到评价区里每个帖子的拷贝。通常您可以自己选择是否订阅。但是，有时订阅是强制性的，使每个人都必须收到帖子的email拷贝。';
$string['subscriptionmode'] = '订阅模式';
$string['subscriptionmode_help'] = '当用户订阅了评价区时，他们会通过email收到帖子的拷贝。
...
$string['thistwfisthrottled'] = '这个评价区有规定周期内发帖数的限制，它被设置为 {$a->blockperiod} 内最多发 {$a->blockafter} 个帖子。';
$string['timedposts'] = '定时帖子';
$string['timestartenderror'] = '可视时段的结束时间不能早于开始时间。';
$string['tracktwf'] = '跟踪未读帖子';
$string['tracking'] = '跟踪';
$string['trackingoff'] = '关闭';
$string['trackingon'] = '开启';
$string['trackingoptional'] = '可选';
$string['trackingtype'] = '是否跟踪此评价区的阅读情况';
$string['trackingtype_help'] = '如果激活，用户可以跟踪评价区和话题里已阅读和没阅读的消息。
...
$string['unsubscribe'] = '不再订阅该评价区';
$string['unsubscribeall'] = '取消所有评价区订阅';
$string['unsubscribeallconfirm'] = '您目前订阅了{$a}。您确认要取消所有评价区的订阅，并禁止自动订阅吗？';
$string['unsubscribeallconfirmtwfs'] = '你当前已经订阅{$a->twfs}论坛。你确认取消所有论坛的订阅，并禁用自动订阅评价区？';
$string['unsubscribealldone'] = '已为您取消所有可选的订阅，但仍能收到强制订阅的通知。到“我的个人资料”设置中的消息页面管理评价区通知。';
$string['unsubscribeallempty'] = '您没有订阅任何评价区。到“我的个人资料”设置中的消息页面可以设置不接收本站的任何通知。';
$string['unsubscribed'] = '未订阅';
$string['unsubscribediscussion'] = '取消此评价区订阅';
$string['unsubscribeshort'] = '退订';
$string['usermarksread'] = '手动标记阅读消息';
$string['viewalldiscussions'] = '查看所有话题';
$string['warnafter'] = '发多少帖后警告';
$string['warnafter_help'] = '当学生将达到某一时长内允许的最大发帖数时，会被警告。此项设置决定了发多少个帖子后会被警告。有mod/twf:postwithoutthrottling权限的用户不受此限。';
$string['warnformorepost'] = '警告！此评价区有不只一个话题——正使用最新话题';
