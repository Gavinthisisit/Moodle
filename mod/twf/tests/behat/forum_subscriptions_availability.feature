...
Feature: As a teacher I need to see an accurate list of subscribed users
  In order to see who is subscribed to a twf
  As a teacher
  ...
  @javascript
  Scenario: A forced twf lists all subscribers
  ...
  Scenario: A forced twf does not allow to edit the subscribers
    When I add a "Forum" to section "1" and I fill the form with:
  ...
  Scenario: A forced and hidden twf lists only teachers
    When I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Forced Forum 2 |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
  ...
  @javascript
  Scenario: An automatic twf lists all subscribers
    When I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Forced Forum 1 |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
