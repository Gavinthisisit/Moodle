...
Feature: A user can control their own subscription preferences for a discussion
  ...
  Scenario: An optional twf can have discussions subscribed to
  ...
  Scenario: An automatic subscription twf can have discussions unsubscribed from
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test twf name |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
  ...
  Scenario: A user does not lose their preferences when a twf is switch from optional to automatic
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test twf name |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
    ...
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject two" "table_row"
    When I follow "Unsubscribe from this twf"
    And I follow "Continue"
    Then I should see "Subscribe to this twf"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"
  ...
  Scenario: An optional twf prompts a user to subscribe to a discussion when posting unless they have already chosen not to subscribe
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test twf name |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
    ...
    And I follow "Test twf name"
    And I should see "Subscribe to this twf"
    And I reply "Test post subject one" post from "Test twf name" twf with:
      | Subject | Reply 1 to discussion 1 |
      | Message | Discussion contents 1, second message |
      | Discussion subscription | 1 |
    And I reply "Test post subject two" post from "Test twf name" twf with:
      | Subject | Reply 1 to discussion 1 |
      | Message | Discussion contents 1, second message |
  ...
  Scenario: An automatic twf prompts a user to subscribe to a discussion when posting unless they have already chosen not to subscribe
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test twf name |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
