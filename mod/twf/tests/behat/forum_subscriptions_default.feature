...
Feature: A user can control their default discussion subscription settings
  ...
  Scenario: Creating a new discussion in an optional twf follows user preferences
  ...
  Scenario: Replying to an existing discussion in an optional twf follows user preferences
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test twf name |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
  ...
  Scenario: Creating a new discussion in an automatic twf follows twf subscription
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test twf name |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
  ...
  Scenario: Replying to an existing discussion in an automatic twf follows twf subscription
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test twf name |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
  ...
  Scenario: Replying to an existing discussion in an automatic twf which has been unsubscribed from follows user preferences
    Given I add a "Forum" to section "1" and I fill the form with:
      | Forum name        | Test twf name |
      | Forum type        | Standard twf for general use |
      | Description       | Test twf description |
