YUI.add('moodle-mod_twf-subscriptiontoggle', function (Y, NAME) {
 ...
 * @main       moodle-mod_twf-subscriptiontoggle
 */
...
var LOGNAME = 'moodle-mod_twf-subscriptiontoggle';
...
Y.extend(SubscriptionToggle, Y.Base, {
    ...
    _toggleSubscription: function(e) {
        ...
        Y.io(this.get('uri'), {
            data: {
                ...
                twfid: clickedLink.getData('twfid'),
    ...
    ATTRS: {
         ...
         * @attribute uri
         * @type String
         * @default M.cfg.wwwroot + '/mod/twf/subscribe_ajax.php'
         */
        uri: {
            value: M.cfg.wwwroot + '/mod/twf/subscribe_ajax.php'
        }
    }
});

var NS = Y.namespace('M.mod_twf.subscriptiontoggle');
